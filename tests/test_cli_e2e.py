...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["page", "601"], None, None, ["Page: Week 4 Overview", "Mathematics 101", "Week 4", "Welcome to week 4."], [], [], [], [], []),
        (["page", "601", "--json"], json.loads, expected_json(PAGE.to_dict()), None, [], [], [], [], []),
        (["page", "601", "--yaml"], yaml.safe_load, PAGE.to_dict(), None, [], [], [], [], []),
        (["folder", "701"], None, None, ["Folder: Week 4 Files", "Mathematics 101", "Week 4", "slides.pdf", "worksheet.docx"], [], [], [], [], []),
        (["folder", "701", "--json"], json.loads, expected_json(FOLDER.to_dict()), None, [], [], [], [], []),
        (["folder", "701", "--yaml"], yaml.safe_load, FOLDER.to_dict(), None, [], [], [], [], []),
